...
interface _ALSNetworkTools {
  enabled: boolean;
  ping_enabled: boolean;
  traceroute_enabled: boolean;
  iperf3_enabled: boolean;
  iperf3_port_range: [number, number];
  max_ping_count: number;
  max_traceroute_hops: number;
  ping_timeout: number;
  traceroute_timeout: number;
}

interface _ALSBandwidth {
  enabled: boolean;
...
interface _ALSFeatures {
  enabled: boolean;
  speedtest: _ALSSpeedTest;
  network_tools: _ALSNetworkTools;
  bandwidth: _ALSBandwidth;
}
...
export type ALSFeatures = CamelCasedPropertiesDeep<_ALSFeatures>;
export type ALSSpeedTest = CamelCasedProperties<_ALSSpeedTest>;
export type ALSNetworkTools = CamelCasedProperties<_ALSNetworkTools>;
export type ALSBandwidth = CamelCasedProperties<_ALSBandwidth>;
